...
public final class PropPairOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.proto.PropPairOuterClass.internal_static_PropPair_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.proto.PropPairOuterClass.PropPair.class, emu.grasscutter.net.proto.PropPairOuterClass.PropPair.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.PropPairOuterClass.PropPair)) {
    ...
    public static emu.grasscutter.net.proto.PropPairOuterClass.PropPair parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.PropPairOuterClass.PropPair prototype) {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.PropPairOuterClass.PropPair buildPartial() {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.PropPairOuterClass.PropPair) {
          return mergeFrom((emu.grasscutter.net.proto.PropPairOuterClass.PropPair)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PropPairOuterClass.PropPair other) {
      ...
      public Builder mergePropValue(emu.grasscutter.net.proto.PropValueOuterClass.PropValue value) {
        if (propValueBuilder_ == null) {
          if (propValue_ != null) {
            propValue_ =
              emu.grasscutter.net.proto.PropValueOuterClass.PropValue.newBuilder(propValue_).mergeFrom(value).buildPartial();
          } else {
            propValue_ = value;
          }
          onChanged();
    ...
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.proto.PropPairOuterClass.PropPair();
    }

    public static emu.grasscutter.net.proto.PropPairOuterClass.PropPair getDefaultInstance() {
